...
function ckplayerConfig() {
	return {
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			loading: {
				file: 'data:image/swf;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==',
				align: 'center',
				vAlign: 'middle',
				offsetX: -100,
				offsetY: -40
			...
			logo: {
				file: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==',
				align: 'right',
				vAlign: 'top',
				offsetX: -170,
				offsetY: 10
